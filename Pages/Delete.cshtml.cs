...
namespace FruitWebApp.Pages
{
    public class DeleteModel : PageModel
    {
        ...
        {
            // Creeate the HTTP client using the FruitAPI named factory
            var httpClient = _httpClientFactory.CreateClient("FruitAPI");
            ...
            // Return to home (Index) page and add a temporary success/failure
            // message to the page
            if (response.IsSuccessStatusCode)
            {
                TempData["success"] = "Data was deleted sucessfully.";
                return RedirectToPage("Index");
            }
            else
            {
                TempData["failure"] = "Operation was not sucessful";
                return RedirectToPage("Index");
            }
        }
